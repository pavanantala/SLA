...
namespace SoberLivingAmerica.Database.IHelper
{
    public partial interface IDbContext
    {
        ...
        DbSet<dynamic> SetElement<dynamic>() where dynamic : class;
        //DbSet<TEntity> Set<TEntity>() where TEntity : class;
        /// <summary>
        ...
        int EntityFromSqlResult(string sql, params object[] parameters);
        #endregion
    }
}
